...
function getYear(populationA, populationB, growthA, growthB) {
  let yearA = 0;
  while (populationA <= populationB) {
    let newPopulationA = Math.floor((populationA * growthA) / 100);

    populationA += newPopulationA;
    yearA++;

    let newPopulationB = Math.floor((populationB * growthB) / 100);
...
console.log(getYear(62422, 484317, 3.1, 1.0));
